package kr.ecse.explore.coroutine
...
/**
 * Represents a synchronization context that a BukkitScheduler kr.ecse.coin.coroutine is currently in.
 */
enum class SynchronizationContext {

    /**
     * The kr.ecse.coin.coroutine is in synchronous context, and all tasks are scheduled on the main server thread
     */
    SYNC,
    /**
     * The kr.ecse.coin.coroutine is in asynchronous context, and all tasks are scheduled asynchronously to the main server thread.
     */
    ASYNC
